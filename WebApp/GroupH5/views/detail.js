 ...
 */
define(['TuanApp', 'libs', 'c', 'MemCache', 'cHybridShell', 'cUtility', 'cHybridFacade', 'cWidgetMember', 'cWidgetGuider', 'TuanStore', 'TuanBaseView', 'cCommonPageFactory', 'TuanModel', 'CommonStore', 'text!DetailTpl', 'cWidgetFactory', 'CallPhone', 'WechatShare'],
    function (TuanApp, libs, c, MemCache, HybridShell, Util, Facade, WidgetMember, WidgetGuider, TuanStore, TuanBaseView, CommonPageFactory, TuanModel, CommonStore, html, WidgetFactory, CallPhone, WechatShare) {
        var MSG = {
                pageTitle: '团购详情',
        ...
        View = PageView.extend({
            ...
            initWechatShare: function () {
                var data = this.prepareShareData()[0];
